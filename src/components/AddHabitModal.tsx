...
const AddHabitModal: React.FC<AddHabitModalProps> = ({ isOpen, onClose, onSaveHabit, onDeleteHabit, habitToEdit }) => {
              ...
              {[
                ...
                <label key={type.value} className="flex items-start space-x-3 cursor-pointer">
                  <input
                    ...
                    className="mt-1 w-4 h-4 text-green-500 bg-[#1C1C1E] border-gray-600 focus:ring-green-500"
                  />
                  <div>
